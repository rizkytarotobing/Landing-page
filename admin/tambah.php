        ...
        <aside>
            ...
            <div class="aside-menu">
                ...
                <div class="menu">
                    ...
                    <a href="tambah.php"><span style=" font-weight: lighter; margin: 0 5px;"> | </span> Tambah Barang</a>
                </div>
                <div class="menu">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input style="width: fit-content;" type="radio" id="kategoriProduk"
                                            name="kategoriProduk" value="alat" checked>
                                        <label for="kategoriProduk">Tenda</label><input style="width: fit-content;"
                                            type="radio" id="kategoriProduk" name="kategoriProduk" value="tenda">
                                        <label for="kategoriProduk">Barang</label>
                                    </td>
                                </tr>
                                <tr>
